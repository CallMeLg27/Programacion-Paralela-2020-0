//============================================================================
// Name        : EjemploMaximum.cpp
// Author      : Esquivel Grados Luis Germán
// Version     : 1.0
// Copyright   : Distribucion libre
// Description : Efectúa la operación "Máximo" usando varios procesos para agilizar el trabajo
//============================================================================
...
int main(int argc, char *argv[]) {
	...
	local_max=maximo(VectorALocal,tama/size);
	...
	if(rank==0){
			 ...
			 cout<<"Maximo de A: "<<total_max<<endl;
		 }
	 MPI_Finalize();
	return 0;
}
